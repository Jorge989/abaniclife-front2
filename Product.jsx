...
const Product = () => {
  const [selectedIngredient, setSelectedIngredient] =
    useState("acido-hialuronico");

  const ingredients = {
    "acido-hialuronico": {
      title: "Ácido Hialurônico",
      description:
        "Com benefícios de retenção de água que ajudam a manter a pele hidratada e com aparência jovem.",
    ...
    retinol: {
      title: "Retinol",
      description:
        "Ingrediente anti-idade que ajuda a renovar a pele e reduzir sinais de envelhecimento.",
      image: "/api/placeholder/300/400",
      color: "bg-gray-600",
    },
    cafeina: {
      title: "Cafeína",
      description:
        "Estimula a circulação e ajuda a reduzir o inchaço e a aparência de olheiras.",
      image: "/api/placeholder/300/400",
      color: "bg-slate-800",
    },
  };
                  ...
                  <div className="bg-white rounded-lg shadow-lg p-4 transform -rotate-12">
                    <div className="w-16 h-32 bg-gradient-to-b from-gray-100 to-gray-200 rounded-lg relative">
                      <div className="absolute top-2 left-2 right-2 h-20 bg-white rounded border border-gray-200 flex items-center justify-center">
                        <span className="text-xs font-bold text-gray-800 transform rotate-90">
                          HIDRATANTE
                        </span>
                      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  ácido hialurônico, peptídeos, ceramidas, niacinamida, vitamina
                  E, extrato de chá verde, ácido hialurônico, peptídeos,
                  ceramidas, niacinamida, vitamina E, extrato de chá verde.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Card className="overflow-hidden">
                <div
                  className={`${ingredients[selectedIngredient].color} h-80 relative`}
                >
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      <div
                        className={`w-16 h-16 ${ingredient.color} rounded-lg flex-shrink-0`}
                      ></div>
                      <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  Fórmula avançada que proporciona hidratação duradoura por até
                  24 horas.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  Proteção eficaz contra raios UVA e UVB, prevenindo o
            ...
            <Card className="text-center">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  100% vegano, livre de crueldade animal e com ingredientes
